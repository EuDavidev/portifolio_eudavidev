...
// Glyph oficial do WhatsApp (Simple Icons), inline para não adicionar dependência.
...
const WhatsAppButton = () => {
    ...
    return (
        <motion.a
            ...
            aria-label="Conversar com Davi Souza no WhatsApp"
            initial={{ scale: 0, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
            transition={
                reduced
                    ? { duration: 0.2 }
                    : { type: 'spring', stiffness: 260, damping: 20, delay: 1.6 }
            }
